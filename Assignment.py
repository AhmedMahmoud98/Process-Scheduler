...
for i in range(1, Number_Of_Processes + 1):
    Process_Data = (int(np.random.normal(Arrival_Time_Parameters[0], Arrival_Time_Parameters[1])),
    int(np.random.normal(Burst_Time_Parameters[0], Burst_Time_Parameters[1])),
    np.random.poisson(Priority_Parameter))
